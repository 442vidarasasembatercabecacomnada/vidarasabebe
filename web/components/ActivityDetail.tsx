...
local Themes = {
	...
	supernova = {
		...
		AcrylicBorder = Color3.fromRGB(22, 22, 22),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(22, 22, 22), Color3.fromRGB(22, 22, 22)),
		AcrylicNoise = 1,
		TitleBarLine = Color3.fromRGB(22, 22, 22),
		DialogHolderLine = Color3.fromRGB(30, 30, 30),
		Tab = Color3.fromRGB(38, 38, 38),
		Element = Color3.fromRGB(26, 26, 26),
		ElementBorder = Color3.fromRGB(26, 26, 26),
...
Components.Tab = (function()
	...
	function TabModule:GetCurrentTabPos()
		...
		local TabHolder = TabModule.Window.TabHolder
		
		local TabHolderPos = TabHolder.AbsolutePosition.Y
		local TabPos = TabFrame.AbsolutePosition.Y
		local TabSize = TabFrame.AbsoluteSize.Y
	...
	function TabModule:New(Title, Icon, Parent)
		...
		colorMotor:onStep(function(v)
			if textIcon then
				...
				local activeColor = Creator.GetThemeProperty("Text")
				
				textIcon.ImageColor3 = subTextColor:Lerp(activeColor, v)
			end
		end)

		function Tab.UpdateSelectionStyle(selected)
			Tab.Selected = selected
			Tab.SetTransparency(selected and 1 or 1) 
			
			colorMotor:setGoal(Flipper.Spring.new(selected and 1 or 0, {
				frequency = 5
			}))
		end
		...
		Creator.AddSignal(Tab.Frame.MouseEnter, function()
			if not Tab.Selected then
				...
				colorMotor:setGoal(Flipper.Spring.new(0.5, { frequency = 8 }))
			end
		end)
		...
		Creator.AddSignal(Tab.Frame.MouseLeave, function()
			if not Tab.Selected then
				Tab.SetTransparency(1)
				colorMotor:setGoal(Flipper.Spring.new(0, { frequency = 8 }))
			end
		end)
		...
		Creator.AddSignal(Tab.Frame.MouseButton1Up, function()
			Tab.SetTransparency(Tab.Selected and 1 or 1)
		end)
		...
		function Tab:AddSection(SectionTitle, SectionIcon)
			...
			if not fischbypass and Library:GetIcon(icon) then
	...
	function TabModule:SelectTab(Tab)
		...
		for i, TabObject in pairs(TabModule.Tabs) do
			TabObject.UpdateSelectionStyle(i == Tab)
		end

		if Window.TabDisplay then Window.TabDisplay.Text = TabModule.Tabs[Tab].Name end
...
Components.Notification = (function()
	...
	function Notification:Init()
		...
		local screenGui = playerGui:FindFirstChild("NotifySystem")
		...
		Notification.Holder.BackgroundTransparency = 1
		Notification.Holder.Position = UDim2.new(1, 0, 0, 80)
		Notification.Holder.Size = UDim2.new(0, 300, 1, -20)
		Notification.Holder.AnchorPoint = Vector2.new(1, 0)
		Notification.Holder.Parent = screenGui

		local layout = Instance.new("UIListLayout")
		layout.Padding = UDim.new(0, 8)
		layout.HorizontalAlignment = Enum.HorizontalAlignment.Right
		layout.VerticalAlignment = Enum.VerticalAlignment.Top
		layout.Parent = Notification.Holder
	end
	...
	function Notification:New(Config)
		...
		frame.Parent = Notification.Holder
		...
		-- Ajusta tamanho
		task.wait()
		frame.Size = UDim2.new(1, 0, 0, 40 + content.TextBounds.Y)
		...
		TweenService:Create(content, fadeIn, {TextTransparency = 0}):Play()
		TweenService:Create(bar, fadeIn, {BackgroundTransparency = 0}):Play()

		-- Timer
		if Config.Duration then
			TweenService:Create(bar, TweenInfo.new(Config.Duration, Enum.EasingStyle.Linear), {
...
Components.Window = (function()
	...
	return function(Config)
		...
		local TabFrame = New("Frame", {
			...
			Position = UDim2.new(0, 10, 0, 48), -- posicao dos tabs
			BackgroundTransparency = 1,
		...
		Window.ContainerCanvas = New("Frame", {
			Size = UDim2.new(1, -(Window.TabWidth + 30), 1, -65),
			Position = UDim2.fromOffset(Window.TabWidth + 20, 48), -- posicao do conteudo
			BackgroundTransparency = 1,
